...
GO
/****** Object:  StoredProcedure [dbo].[CHAMPIONS.SP_LIST]    Script Date: 19-Dec-20 1:12:50 PM ******/
DROP PROCEDURE [dbo].[CHAMPIONS.SP_LIST]
GO
/****** Object:  StoredProcedure [dbo].[CHAMPIONS.SP_LIST]    Script Date: 19-Dec-20 1:12:50 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[CHAMPIONS.SP_LIST]
AS
BEGIN
	SET NOCOUNT ON;
	BEGIN TRY
